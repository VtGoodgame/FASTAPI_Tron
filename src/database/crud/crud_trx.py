...
from src.database.models import TRC20Transaction
from Schemas.API_schema import TransactionItem, ms_to_datetime


def save_transaction(db: Session, trx: TransactionItem):
...
def get_last_100_transactions(db: Session):
    return db.query(TRC20Transaction)\
